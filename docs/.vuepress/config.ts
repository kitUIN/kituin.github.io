...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    { text: '控制台', link: 'https://nacho.kituin.fun/' },
],
...
author: {
  ...
  footer: {
    ...
    copyrightInfo:
      'KitUIN | <a href="https://github.com/kitUIN/kituin.github.io/blob/master/LICENSE" target="_blank">MIT License</a> | <a href="https://beian.miit.gov.cn/" target="_blank">浙ICP备2023024391号</a>', // 博客版权信息，支持a标签
  },
