...
| `resp.raw[0].anilistID`     | 匹配的[Anilist  ID](https://anilist.co/)                                                                                                                                                                                                              | int |
| `resp.raw[0].title`         | 番剧名字(包含国际,罗马音,英文)  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                          | dict |
| `resp.raw[0].title_native`  | 番剧国际名字  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                                     | str |
| `resp.raw[0].title_romaji`  | 番剧罗马音名字  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                                    | str |
| `resp.raw[0].title_english` | 番剧英文名字  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                                     | str |
| `resp.raw[0].title_chinese` | 番剧中文名字  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)并且[`chineseTitle`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L70) 设为 `True` (默认)时) | str |
| `resp.raw[0].idMal`         | 匹配的[MyAnimelist  ID](https://myanimelist.net/)   ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                            | int |
| `resp.raw[0].synonyms`      | 备用英文标题  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                                     | list |
| `resp.raw[0].isAdult`       | 是否R18  ( [`anilistInfo`](https://github.com/kitUIN/PicImageSearch/blob/main/PicImageSearch/tracemoe.py#L69)  设为 `True` (默认)时)                                                                                                                      | bool |
...
| `resp.raw[0].anime_info`         | 标题信息                                                                                                                                                                                                                                             | dict |
