...
# saucenao = SauceNAO(api_key='请输入你的key',**_REQUESTS_KWARGS)
# 如果需要代理
...
- name: 前往查看
  desc: 🚀同步测试文件Demo
  link: https://github.com/kitUIN/PicImageSearch/tree/main/test/saucenao_test.py
  textColor: '#2A3344'

- name: 前往查看
  desc: 🚀异步测试文件Demo
  link: https://github.com/kitUIN/PicImageSearch/blob/main/test/Async/saucenao_test.py
  bgColor: '#DFEEE7'
  textColor: '#2A3344'
```
:::
